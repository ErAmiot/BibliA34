...
if(isset($_GET["clientNom"]) && isset($_GET["clientPrenom"])) {
  $clientPrenom=htmlentities($_GET["clientPrenom"]);
  $clientNom=htmlentities($_GET["clientNom"]);
...
elseif (isset($_GET["dateEmp"])) {
  $dateEmp=htmlentities($_GET["dateEmp"]);
...
elseif (isset($_GET["DateEmpRetMax"])) {
  $DateEmpRetMax=htmlentities($_GET["DateEmpRetMax"]);
